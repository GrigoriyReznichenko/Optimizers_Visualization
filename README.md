...
Here is a GUI which shows most popular optimization algorithms in process. It visualizes problems like getting stuck at saddle points and Adam failure in strongly convex optimization cases.
...
6) Adam Optimizer:
	...
	The codition of convegrence of the algorithm is the Euclidian distance between optimal point and current point is smaller then threshold.
