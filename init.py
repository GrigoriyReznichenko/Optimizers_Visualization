...
class Ui_Form(QtWidgets.QWidget):
    ...
    def retranslateUi(self, Form):
        ...
        self.radio_rmsprop.setText(self._translate("Form", "RMSProp optimizer"))
        self.val_sgd_mu.setText(self._translate("Form", "0.01"))
        self.label_adadelta_eps.setText(self._translate("Form", "<html><head/><body><p>&epsilon;</p></body></html>"))
        self.val_adam_beta.setText(self._translate("Form", "0.9"))
        self.label_adam_eps.setText(self._translate("Form", "<html><head/><body><p>&epsilon;</p></body></html>"))
        self.val_adadelta_mu.setText(self._translate("Form", "0.01"))
        self.val_rms_eps.setText(self._translate("Form", "0.000001"))
        self.val_adam_mu.setText(self._translate("Form", "0.01"))
        self.label_adadelta_gamma.setText(self._translate("Form", "<html><head/><body><p>&gamma;</p></body></html>"))
        self.val_adam_eps.setText(self._translate("Form", "0.000001"))
        self.comboBox.setItemText(0, self._translate("Form", "Himmelblau's function"))
        self.comboBox.setItemText(1, self._translate("Form", "Beale function"))
        self.comboBox.setItemText(2, self._translate("Form", "Booth function"))
        self.comboBox.setItemText(3, self._translate("Form", "Bukin function"))
        self.comboBox.setItemText(4, self._translate("Form", "Matyas function"))
        self.comboBox.setItemText(5, self._translate("Form", "McCormick function"))
        self.comboBox.setItemText(6, self._translate("Form", "Sphere function"))
        self.label_momentum_beta.setText(self._translate("Form", "<html><head/><body><p>&beta;</p></body></html>"))
        self.label_adagrad.setText(self._translate("Form", "Adagrad"))
        self.val_adagrad_mu.setText(self._translate("Form", "0.4"))
        self.val_adadelta_eps.setText(self._translate("Form", "0.000001"))
        self.val_momentum_mu.setText(self._translate("Form", "0.01"))
        self.label_momentum_mu.setText(self._translate("Form", "<html><head/><body><p>&mu;</p></body></html>"))
        self.val_rms_mu.setText(self._translate("Form", "0.01"))
        self.label_adam_beta.setText(self._translate("Form", "<html><head/><body><p>&beta;</p></body></html>"))
        self.radio_momentum.setText(self._translate("Form", "Momentum optimizer"))
        self.val_adadelta_beta.setText(self._translate("Form", "0.9"))
        self.label_rms_mu.setText(self._translate("Form", "<html><head/><body><p>&mu;</p></body></html>"))
        self.label_adagrad_eps.setText(self._translate("Form", "<html><head/><body><p>&epsilon;</p></body></html>"))
        self.label_sgd_mu.setText(self._translate("Form", "<html><head/><body><p>&mu;</p></body></html>"))
        self.label_rms_eps.setText(self._translate("Form", "<html><head/><body><p>&epsilon;</p></body></html>"))
        self.label_sgd.setText(self._translate("Form", "SGD"))
        self.label_adagrad_mu.setText(self._translate("Form", "<html><head/><body><p>&mu;</p></body></html>"))
        self.label_rms.setText(self._translate("Form", "RMSProp"))
        self.val_momentum_beta.setText(self._translate("Form", "0.9"))
        self.radio_adagrad.setText(self._translate("Form", "Adagrad optimizer"))
        self.label_adadelta_beta.setText(self._translate("Form", "<html><head/><body><p>&beta;</p></body></html>"))
        self.val_adam_gamma.setText(self._translate("Form", "0.9"))
        self.val_adadelta_gamma.setText(self._translate("Form", "0.9"))
        self.label_adadelta.setText(self._translate("Form", "Adadelta"))
        self.label_adam.setText(self._translate("Form", "Adam"))
        self.label_adam.setText(self._translate("Form", "Adam"))
        self.radio_adadelta.setText(self._translate("Form", "Adadelta optimizer"))
        self.label_adadelta_mu.setText(self._translate("Form", "<html><head/><body><p>&mu;</p></body></html>"))
        self.label_adam_gamma.setText(self._translate("Form", "<html><head/><body><p>&gamma;</p></body></html>"))
        self.radio_adam.setText(self._translate("Form", "Adam optimizer"))
        self.label_momentum.setText(self._translate("Form", "Momentum"))
        self.val_rms_beta.setText(self._translate("Form", "0.9"))
        self.val_adagrad_eps.setText(self._translate("Form", "0.000001"))
        self.label_rms_beta.setText(self._translate("Form", "<html><head/><body><p>&beta;</p></body></html>"))
        self.label_adam_mu.setText(self._translate("Form", "<html><head/><body><p>&mu;</p></body></html>"))
        self.radio_sgd.setText(self._translate("Form", "Stohastic Gradient Descent"))